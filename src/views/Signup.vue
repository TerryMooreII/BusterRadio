<template>
  <div class="flex-grow mt-24 width-full antialiased">     
    <div class="flex antialiased text-grey-darker leading-normal bg-white justify-around ">
      <div class="flex flex-col shadow-lg rounded w-3/5 p-6 ">
